...
<table width="441" border="0" class="vtable" style="margin-left:160px;"">
  <tr align="center">
  ...
  <tr>
    ...
    <td align="center"><a title="Update" href="index.php?pil=edit_divisi&kode_divisi=<?php echo $row['0'];?>"><img src="../asset/images/edit.png"/></a> <a  title="Delete" href="viewDivisi.php?pil=delete&kode_divisi=<?php echo $row['0'];?>"><img src="../asset/images/deleted.png"/></a> </td>
  </tr>
  <?php }?>
</table>

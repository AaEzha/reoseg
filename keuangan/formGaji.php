...
function addGetNip() {
 ...
 // var y = document.getElementById('divisi');
  getCmb = x.value;
  //y.value = getCmb;
  ...
  ajaxku.open("GET",url+"?nip="+getCmb,true);
  ajaxku.send();
...
function stateChanged1(){
	...
	if (ajaxku.readyState==4){
		data=ajaxku.responseText;
		document.getElementById("jamlembur").value = data[0];
...
<div class="form-all">
  ...
  <div class="form-header-group" style="width:780px;">
  ...
  <table width="771" height="163" border="0">
    <tr>
      <td width="135">No.Slip </td>
      <td width="250"><input name="kodegaji" type="text" id="kodegaji" size="12" value="<?php echo $kode?>"></td>
      <td width="18">&nbsp;</td>
      <td width="139">Gaji Bulan</td>
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td>Email</td>
      <td width="207"><input name="email" type="text" id="email" size="25" placeholder="Email" readonly></td>
      </tr>
    <tr>
      <td>Divisi</td>
    ...
    <tr>
      ...
      <td><input name="jamlembur" type="text" id="jamlembur" size="15" value="0" placeholder="Jam Lembur" readonly></td>
      </tr>
    <tr>

  ...
  <tr>
    <td><div align="center">
      <table width="603" border="0" class="form-all" style="font-size:13px;">
        ...
        <tr>
          <td>&nbsp;</td>
          <td colspan="7" style="color:#25A6E1;"><div align="center"><strong>REKAP</strong></div></td>
          </tr>
        <tr>
          <td>&nbsp;</td>
          <td colspan="7"><div align="center" style="color:#25A6E1;" ><strong>GAJI  KARYAWAN</strong></div></td>
          </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
          ...
          <td colspan="2" rowspan="5"><div align="center"><img src="asset/images/<?php echo $gaji['photo']?>" width="100" height="100"/></div></td>
          </tr>
        <tr>
          <td>&nbsp;</td>
          <td colspan="3">NIP</td>
        ...
        <tr>
          <td>&nbsp;</td>
          <td colspan="3">Tempat Lahir</td>
          <td>:</td>
          <td><?php echo $gaji['tempat_lahir']?></td>
          </tr>
        <tr>
          <td>&nbsp;</td>
          <td colspan="3">Tanggal Lahir</td>
          <td>:</td>
          <td><?php echo $gaji['tgl_lahir']?></td>
          </tr>
        <tr>
          <td>&nbsp;</td>
          <td colspan="3">Jenis Kelamin</td>
          <td>:</td>
          <td colspan="3"><?php echo $gaji['jk']?></td>
          </tr>
        <tr>
          <td>&nbsp;</td>
          <td colspan="3">Status</td>
          <td>:</td>
          <td colspan="3"><?php echo $gaji['status_pernikahan']?></td>
          </tr>
        <tr>
          <td>&nbsp;</td>
          <td colspan="3">No. HP</td>
          <td>:</td>
          <td colspan="3"><?php echo $gaji['hp']?></td>
          </tr>
        <tr>
          <td>&nbsp;</td>
          <td colspan="3">Email</td>
          <td>:</td>
          <td colspan="3"><?php echo $gaji['email']?></td>
          </tr>
        <tr>
          <td>&nbsp;</td>
          <td colspan="3">Pendidikan Terakhir</td>
          <td>:</td>
          <td colspan="3"><?php echo $gaji['pendidikan_terakhir']?></td>
          </tr>
        <tr>
          <td colspan="8">&nbsp;</td>
          </tr>
        <tr>
          <td>&nbsp;</td>
          <td colspan="7" style="color:#25A6E1;"><strong>Data Gaji</strong></td>
          </tr>
        <tr>
          <td>&nbsp;</td>

...
<div class="form-all">
  ...
  <table width="455" border="0" style="margin-left:85px;">
    <tr>
      <td>Kode Report</td>
	...
	if(isset($_POST['submit'])){
		...
		}else
		{
			if(file_exists("../asset/laporan/".$nama_file)){
				echo '<script language="javascript">alert("File Gagal di Upload Karena Sudah Ada !!! Coba Ganti Nama File");location.replace("index.php?pil=view_laporan"); </script>';
				die();
